...
const SeasonalInfo = () => {
  return <section id="sezony" className="bg-forest-50 section-padding rounded-3xl mx-4 md:mx-8 max-w-6xl xl:mx-auto">
      ...
      <div className="mt-16 relative">
        ...
        {seasonTimeline.map((item, index) => <div key={index} className={`flex flex-col md:flex-row md:items-center md:justify-between mb-10 md:mb-16 relative opacity-0 ${index % 2 === 0 ? 'animate-slide-in-left' : 'animate-slide-in-right'}`}>
