...
const Hero = () => {
  return <section id="strona-główna" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <picture>
          <source srcSet="/lovable-uploads/e086ccdf-8897-40f8-8eeb-643228b8dbca.webp" type="image/webp" />
          <img src="/lovable-uploads/e086ccdf-8897-40f8-8eeb-643228b8dbca.png" alt="Plantacja choinek" className="w-full h-full object-cover" loading="eager" decoding="async" fetchPriority="high" sizes="100vw" width="1920" height="1080" />
        </picture>
      </div>
