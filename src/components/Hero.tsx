...
const Hero = () => {
  return <section id="strona-główna" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-20 text-center">
        ...
        <p className="mt-6 text-xl md:text-2xl text-white/90 opacity-0 animate-fade-in-delay-1 max-w-2xl mx-auto">Tradycja, jakość i szacunek do natury od ponad 20 lat
Ty wybierasz My ścinamy</p>
